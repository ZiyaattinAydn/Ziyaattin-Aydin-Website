        ...
        <div className="min-w-0">
          ...
          <main className="p-4 sm:p-6 lg:p-10">
            <div className="mb-6 rounded-2xl border border-[var(--border)] bg-[rgba(18,217,120,0.04)] px-4 py-3 text-xs leading-6 text-[var(--muted)] sm:text-sm">
              <strong className="text-[var(--foreground)]">Studio Sprint 01:</strong> Bu ekranlar hazırlık ve mock veri kabuğudur; gerçek login,
              MFA, database ve storage henüz uygulanmadı.
            </div>
            {children}
          </main>
        </div>
