...
| `visibility` | Studio görünürlük seçimi | `private` kayıt public route içinde render edilmez; `public` kayıt listelenebilir. |
| `publishState` | Studio publish kararının public karşılığı | Production listelerde `published` beklenir; mock sprintlerde `draft/review` etiketle gösterilebilir. |
